...
public abstract class JCTree implements Tree, Cloneable, DiagnosticPosition {
     ...
     */
    public static final int EXEC = IF + 1; //20
     ...
     */
    public static final int ASSIGN = PARENS + 1; //30
     ...
     */
    public static final int TYPEUNION = TYPEAPPLY + 1; //40
    ...
    public static final int NOT = NEG + 1;                   // ! 50
